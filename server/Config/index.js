module.exports = {
  reportConfig: {
    clinical: {
      common: {
        review: {
          ...
          options: [
            ...
            { title: 'TR-24 แพทย์ปฏิเสธการรับ admit ผู้ป่วย  refer in', value: 'TR-24'},
            { title: 'TR-25 แพทย์ปฏิเสธการ admit ผู้ป่วย', value: 'TR-25'}
          ]
        },
        PCT: {
          title: 'โปรแกรมความเสี่ยงด้านการดูแลผู้ป่วย (PCT)',
          options: [
            { title: 'คัดกรอง-ประเมินผู้ป่วยล่าช้า/คลาดเคลื่อน', value: '1', child: []},
            ...
            { title: 'การระบุตัวผู้ป่วยผิดพลาด (Patient   Identification)', value: '', child: [
              ...
              { title: 'การสั่งการรักษาผิดคน', value: '5.6'}
            ]},
            ...
            { title: 'การให้เลือดผิดคน  ผิดหมู่ ผิดชนิด', value: '13', child: []},
            ...
            { title: 'รายงานผลการตรวจทางรังสีวิทยาผิดพลาด/ผิดคน/ไม่ครบถ้วน/ล่าช้า', value: '22', child: []},
            { title: 'การส่งตรวจทางรังสีวิทยาเพื่อประกอบวินิจฉัยโรค การรักษา ไม่ครบ/ไม่เหมาะสม', value: '23', child: []},
            { title: 'เอกซเรย์หรือตรวจทางรังสี ผิดคำสั่ง/ผิดคน/ผิดข้าง/ผิดตำแหน่ง/ผิดเทคนิค', value: '24', child: []},
        ...
        IC: {
          ...
          options: [
            ...
            { title: 'บุคลากรติดเชื้อจากการปฏิบัติหน้าที่', value: '7', child: []},
          ]
        },
        PTC: {
      ...
      spacific: {
        gynecology: {
          title: 'ความเสี่ยงเฉพาะโรคสาขาสูติกรรม',
          options: [
        ...
        dental: {
          ...
          options: [
            ...
            {title: 'ถอนฟันผิดซี่', value: '4'},
            {title: 'มีอาการเสียวฟันหลังทำครอบฟัน', value: '5'},
            {title: 'มีอาการปวด หลังทำครอบฟัน', value: '6'},
            {title: 'มีอาการปวด/เสียวหลังอุดฟัน', value: '7'}
          ]
        },
      },
      event: {
    ...
    nonClinical: {
      ...
      im: {
        ...
        options: [
          ...
          {title: 'ไม่ได้สแกนเอกสาร/สแกนไม่ครบ', value: '8'},
        ]
      },
      hrd: {
      ...
      budget: {
        title: 'โปรแกรมความเสี่ยงด้านการเงิน งบประมาณและพัสดุ',
        options: [
          {title: 'เกิดความผิดพลาดของการจัดการทรัพย์สิน ไม่ถูกระเบียบ/ไม่ตรงตามทะเบียน', value: '1'},
          {title: 'เกิดความผิดพลาดเกี่ยวกับเอกสารการรับและเบิกจ่ายเงิน', value: '2'},
          {title: 'เกิดความผิดพลาดในการส่งมอบเงินและเบิกจ่ายเงิน ไม่มีหลักฐานการส่งมอบ/ไม่ถูกระเบียบขั้นตอน/ยอดเงินรวมไม่ตรง', value: '3'},
          {title: 'เกิดความผิดพลาดด้านการควบคุมและแจกจ่ายพัสดุ ไม่ถูกระเบียบ /เกินราคามาตรฐาน', value: '4'},
          {title: 'เกิดความผิดพลาดด้านการจัดการคลังพัสดุ/วางระบบปฏิบัติงาน (ตรวจรับ/จ่ายเงิน)', value: '5'},
          {title: 'เกิดความล่าช้าในการเบิกจ่ายเงิน', value: '6'}
        ]
      },
      rights: {
        ...
        options: [
          ...
          {title: 'ไม่ปฏิบัติตามแนวทาง/คู่มือการปฏิบัติงาน', value: '7'}
        ]
      }
    },
    violence:  {
      ...
      general: {
        ...
        options: [
          // {title: '1 เหตุการณ์ไม่พึงประสงค์ที่อาจก่อให้เกิดผลเสียต่อระบบบริการหรือก่อให้เกิดผลเสียต่อทรัพย์สิน (แต่ยังไม่เกิด)', value: '1'},
          // {title: '2 เหตุการณ์ไม่พึงประสงค์ที่มีผลกระทบต่อระบบงานหรือบริการน้อย (ระบบบริการยังดำเนินการต่อไปได้) และก่อให้เกิดความสูญเสียต่อทรัพย์สินน้อยกว่า 5000 บาท', value: '2'},
          // {title: '3 เหตุการณ์ไม่พึงประสงค์ที่ทำให้ระบบงานหรือบริการไม่สามารถดำเนินได้ตามปกติ น้อยกว่า 3 วันหรือก่อให้เกิดความสูญเสียต่อทรัพย์สินน้อยกว่า 10000 บาท', value: '3'},
          // {title: '4 เหตุการณ์ไม่พึงประสงค์ที่ทำให้ระบบงานหรือบริการไม่สามารถดำเนินการได้ปกติมากกว่า 5 วันหรือก่อให้เกิดความสูญเสียต่อทรัพย์สินมากกว่า 10000 บาท', value: '4'},

          {title: '1 เกิดความผิดพลาดขึ้น แต่ไม่มีผลกระทบต่อผลสำเร็จหรือวัตถุประสงค์ของการดำเนินงาน (* เกิดผลกระทบที่มีมูลค่าความเสียหาย 0 - 10,000 บาท)', value: '1'},
          {title: '2 เกิดความผิดพลาดขึ้นแล้ว โดยมีผลกระทบ (ที่ควบคุมได้) ต่อผลสำเร็จหรือวัตถุประสงค์ของการดำเนินงาน (* เกิดผลกระทบที่มีมูลค่าความเสียหาย 10,001 - 50,000 บาท)', value: '2'},
          {title: '3 เกิดความผิดพลาดขึ้นแล้ว และมีผลกระทบ (ที่ต้องทำการแก้ไข) ต่อผลสำเร็จหรือวัตถุประสงค์ของการดาเนินงาน (* เกิดผลกระทบที่มีมูลค่าความเสียหาย 50,001 - 250,000 บาท)', value: '3'},
          {title: '4 เกิดความผิดพลาดขึ้นแล้ว และทำให้การดำเนินงานไม่บรรลุผลสำเร็จตามเป้าหมาย (* เกิดผลกระทบที่มีมูลค่าความเสียหาย 250,001 – 1,000,000 บาท)', value: '4'},
        ]
      }
    }
  },
  trans: {
    ...
    status: {
      all: 'ทุกสถานะ',
      reportCreated: 'ยังไม่ส่งแบบติดตาม',
      departmentSpecified: 'ส่งแบบติดตามแล้วยังไม่ตอบกลับ',
      hadSomeAnswer: 'ส่งแบบติดตามและตอบกลับบางส่วน',
      hadAllAnswer: 'ส่งแบบติดตามและตอบกลับครบถ้วน',
      approved: 'เสร็จสิ้น(Approvel)'
    }
  },
