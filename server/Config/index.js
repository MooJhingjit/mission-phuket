module.exports = {
  reportConfig: {
    clinical: {
      common: {
        ...
        PCT: {
          ...
          options: [
            { title: '1.คัดกรอง-ประเมินผู้ป่วยล่าช้า', value: '1', child: []},
            { title: '2.การวินิจฉัยล่าช้า/การรักษาผิดพลาด', value: '2', child: []},
            { title: '3.ผู้ป่วยเสียชีวิตจากกระบวนการดูแลรักษาผิดพลาด', value: '3', child: []},
            { title: '4.กลับมารักษาซ้ำภายใน 48 ชม./ 28 วัน/ 7 วัน ด้วยโรค/ภาวะเดิม', value: '4', child: []},
            { title: '5.การระบุตัวผู้ป่วยผิดพลาด (Patient   Identification)', value: '', child: [
              { title: '5.1 เวชระเบียนผิดคน/ติดสติ๊กเกอร์ผิด', value: '5.1'},
              { title: '5.2 ระบุตัวผู้ป่วยในใบนัดผิดคน', value: '5.2'},
              { title: '5.3 ระบุตัวผู้ป่วยในการเก็บสิ่งส่งตรวจผิดคน', value: '5.3'},
              { title: '5.4 ระบุตัวผู้ป่วยในการให้ยาผิดคน', value: '5.4'},
              { title: '5.5 ระบุตัวทารกแรกเกิดผิดคน', value: '5.5'}
            ]},
            { title: '6.ระบบนัด ผิดแพทย์/ผิดเวลา/ผิดคลินิก/ให้ข้อมูลไม่ครบ ไม่ถูกต้อง', value: '6', child: []},
            { title: '7.การส่งต่ออาการ/ประวัติผู้ป่วย ไม่ครบ/ส่งผิดพลาด/ไม่ได้ส่ง', value: '7', child: []},
            { title: '8.การสื่อสารกับผู้ป่วย/เจ้าหน้าที่ ไม่ได้ให้ข้อมูล/ให้ข้อมูลไม่ถูกต้อง', value: '8', child: []},
            { title: '9.การบันทึกข้อมูลไม่ครบถ้วน/ไม่ได้บันทึกข้อมูล/ข้อมูลไม่ถูกต้อง/ข้อมูลไม่อัพเดท', value: '9', child: []},
            { title: '10.ติดต่อเจ้าหน้าที่/แพทย์ไม่ได้', value: '10', child: []},
            { title: '11.ตรวจวิเคราะห์ Lab ผิดพลาด/ล่าช้า/ผิดวิธี', value: '11', child: []},
            { title: '12.ส่งตรวจทางห้องปฏิบัติการไม่ครบ/ไม่ส่งตรวจ/สิ่งส่งตรวจผิด', value: '12', child: []},
            { title: '13.จ่ายเลือดผิดพลาด', value: '13', child: []},
            { title: '14.ผู้ป่วยได้รับอาหารไม่เหมาะสมตามความต้องการพื้นฐาน/การเจ็บป่วย', value: '14', child: []},
            { title: '15.ผู้ป่วยได้รับอาหารที่มีการปนเปื้อน', value: '15', child: []},
            { title: '16.เกิดภาวะแทรกซ้อนหลังทำการรักษา', value: '16', child: []},
            { title: '17.ผู้ป่วยลื่นล้ม/ตกเตียง', value: '17', child: []},
            { title: '18.เกิดแผลกดทับ', value: '18', child: []},
            { title: '19.ผ่าตัดซ้ำโดยไม่ได้วางแผน', value: '19', child: []},
            { title: '20.Un plan ICU', value: '20', child: []},
            { title: '21.ภาวะแทรกซ้อนจากการใช้เครื่องมือ เช่น Burn, trauma', value: '21', child: []},
          ]
        },
        IC: {
          title: 'โปรแกรมความเสี่ยงด้านการป้องกันและควบคุมการติดเชื้อ (IC)',
          options: [
            { title: '1.การติดเชื้อในโรงพยาบาล', value: '', child: [
              { title: '1.1 VAP', value: '1.1'},
              { title: '1.2 CAUTI', value: '1.2'},
              { title: '1.3 Line-BSI', value: '1.3'},
              { title: '1.4 SSI', value: '1.4'},
              { title: '1.5 การติดเชื้อสะดืออักเสบ', value: '1.5'},
              { title: '1.6 การติดเชื้อดื้อยา', value: '1.6'}
            ]},
            { title: '2.อุบัติเหตุจากเข็ม/ของมีคมทิ่ม/ตำ', value: '2', child: []},
            { title: '3.อุบัติเหตุจากการสัมผัสสารคัดหลั่ง/เลือด', value: '3', child: []},
            { title: '4.ไม่ปฏิบัติตามแนวทางของ IC', value: '4', child: []},
            { title: '5.เกิดความผิดพลาดของการแพร่ระบาดของเชื้อโรค (โรคติดต่อ/โรคอุบัติใหม่-อุบัติซ้ำ)', value: '5', child: []},
            { title: '6.ของติดเชื้อติดมากับผ้าที่ส่งซัก', value: '6', child: []},
          ]
        },
        PTC: {
          title: 'โปรแกรมความเสี่ยงด้านระบบยา/ความคลาดเคลื่อนทางยา(PTC)',
          options: [
            {title: '1.ความคลาดเคลื่อนจากการสั่งยา (สั่งยาผิด/ไม่ครบ/วิธีใช้ไม่ถูก): Prescribing error ', value: '1'},
            {title: '2.ความคลาดเคลื่อนจากการจ่ายยา/สารน้ำ/เลือด(ผิดชนิด/ผิดคน/ผิดจำนวน) : Dispensing error', value: '2'},
            {title: '3.ผู้ป่วยแพ้ยาซ้ำ/แพ้เลือด', value: '3'},
            {title: '4.ความคลาดเคลื่อนจากการบริหารยา (แจกยาผิด/แจกยาไม่ครบ/ลืมให้ยา/ฉีดยาผิด/ให้เลือดผิด):Administration error', value: '4'},
            {title: '5.ความคลาดเคลื่อนจากการรับคำสั่ง/จัดยา/สารน้ำ/เลือด ผิด (คัดลอกคำสั่งผิด/คีย์ยาผิด/จัดเตรียมผิด): Transcribing error', value: '5'},
            {title: '6.ผู้ป่วยมีอาการไม่พึงประสงค์จากการใช้ยา', value: '6'},
            {title: '7.ไม่มียา/สารน้ำ/เลือด จ่ายให้ผู้ป่วย', value: '7'},
          ]
        },
        operation: {
          title: 'โปรแกรมความเสี่ยงด้านการผ่าตัด/วิสัญญี',
          options: [
            {title: '1.งด/เลื่อนผ่าตัด/ไม่พร้อมผ่าตัด', value: '1'},
            {title: '2.ภาวะแทรกซ้อนจากการผ่าตัด', value: '2'},
            {title: '3.ทำ spinal block ไม่ถูกต้อง', value: '3'},
            {title: '4.เตรียมผู้ป่วยผ่าตัดไม่พร้อม/ไม่ถูกต้อง', value: '4'},
            {title: '5. ภาวะแทรกซ้อนจากการให้ยาระงับความรู้สึก', value: '5'},
            {title: '6. ลืมสิ่งแปลกปลอมไว้ในตัวผู้ป่วย ', value: '6'},
            {title: '7.เสียชีวิตระหว่างผ่าตัด ', value: '7'},
            {title: '8.ภาวะแทรกซ้อนทางวิสัญญี', value: '8'},
            {title: '9.ตัดอวัยวะออกโดยไม่ได้วางแผน', value: '9'},
      ...
      spacific: {
        ...
        surgery: {
          title: '2. ความเสี่ยงเฉพาะโรคสาขาศัลยกรรม',
          options: [
        ...
        medicine: {
          title: '3. ความเสี่ยงเฉพาะโรคสาขาอายุรกรรม',
          options: [
        ...
        pediatrics: {
          title: '4. ความเสี่ยงเฉพาะโรคสาขากุมารเวชกรรม',
          options: [
        ...
        orthopedic: {
          title: '5. ความเสี่ยงเฉพาะโรคสาขาศัลยกรรมออร์โธปิดิกส์',
          options: [
        ...
        generalEnt: {
          title: '6. ความเสี่ยงเฉพาะโรคสาขาศัลยกรรมทั่วไป- ENT',
          options: [
        ...
        optic: {
          title: '7.ความเสี่ยงเฉพาะโรคสาขาโสต ศอ นาสิก/จักษุ',
          options: [
        ...
        anesthesiology: {
          title: '8.ความเสี่ยงเฉพาะโรคด้านวิสัญญีวิทยา',
          options: [
        ...
        radiology: {
          title: '9.ความเสี่ยงเฉพาะโรค  ด้านรังสีวิทยา',
          options: [
        ...
        dental: {
          title: '10.ความเสี่ยงเฉพาะโรค ด้านทันตกรรม',
          options: [
    ...
    nonClinical: {
      env: {
        title: '1.โปรแกรมความเสี่ยงด้านสิ่งแวดล้อมและความปลอดภัย (ENV)',
        options: [
      ...
      facilities: {
        title: '2.โปรแกรมความเสี่ยงด้านเครื่องมือ อุปกรณ์และสิ่งอำนวยความสะดวก',
        options: [
          {title: '1.เครื่องมือ/อุปกรณ์ทางการแพทย์ สูญหาย/ ไม่พร้อมใช้/ ขัดข้อง/ ไม่เพียงพอ/ ไม่ครบ /มีสิ่งแปลกปลอม/ระบุรายการไม่ถูกต้อง', value: '1'},
          {title: '2.อุปกรณ์ เครื่องมือ อื่นๆติดมากับผ้าที่ส่งซัก', value: '2'},
          {title: '3.ยานพาหนะ ไม่เพียงพอ ไม่พร้อมใช้ สูญหาย', value: '3'}
        ]
      },
      im: {
        title: '3.โปรแกรมความเสี่ยงด้านเวชระเบียนและสารสนเทศ(IM)',
        options: [
          {title: '1.ข้อมูล, เวชระเบียน ไม่สมบูรณ์/สูญหาย', value: '1'},
          {title: '2.ส่งSecond sheet ,รายงาน,หนังสือ,เอกสารผิดแผนก', value: '2'},
          {title: '3.ลงบันทึกข้อมูลไม่ครบถ้วน/ผิดพลาด', value: '3'},
          {title: '4.การสื่อสารผิดพลาด/ขัดข้อง', value: '4'},
          {title: '5.เกิดความผิดพลาดด้านข้อมูล สารสนเทศ ไม่ถูกต้อง/ไม่ครบถ้วน/ไม่บันทึก)', value: '5'},
          {title: '6.ระบบขัดข้อง ไม่พร้อมใช้', value: '6'},
          {title: '7.ความผิดพลาดทางการเงิน/บัญชี', value: '7'},
        ]
      },
      hrd: {
        title: '4.โปรแกรมความเสี่ยงด้านการบริหารและพัฒนาทรัพยากรบุคคล (HRD)',
        options: [
          {title: '1.อัตรากำลังไม่เพียงพอ', value: '1'},
          {title: '2.สมรรถนะ/ทักษะ/ความรู้ในการทำงานไม่เพียงพอ', value: '2'},
          {title: '3.เจ้าหน้าที่มีภาวะเสี่ยง/เจ็บป่วยทางด้านสุขภาพ', value: '3'},
          {title: '4.พฤติกรรมบริการไม่เหมาะสม', value: '4'},
          {title: '5.เกิดความขัดแย้งทำให้เกิดผลกระทบต่อการทำงาน', value: '5'},
          {title: '6.ไม่มีการจัดทำแนวทางการปฏิบัติเรื่องค่าตอบแทน', value: '6'},
        ]
      },
      budget: {
      ...
      rights: {
        title: '6.โปรแกรมด้านสิทธิ จริยธรรม และพฤติกรรมบริการ',
        options: [
          {title: '1.ปฏิบัติโดยมีอคติ และ / หรือ ใช้อำนาจหน้าที่เพื่อผลประโยชน์ส่วนตน', value: '1'},
          {title: '2. ประพฤติตนและประกอบกิจแห่งวิชาชีพโดยไม่ถูกต้องตามกฎหมาย', value: '2'},
          {title: '3. มีการละเมิดสิทธิผู้ป่วยข้อใดข้อหนึ่งเกิดขั้นในขั้นตอนกระบวนการให้บริการ', value: '3'},
          {title: '4. ละเลยการปฏิบัติหน้าที่ หรือปฏิบัติหน้าที่โดยไม่ใช้ความรู้ตามหลักวิชาการ', value: '4'},
          {title: '5. เกิดเหตุการณ์การทุจริตในหน้าที่', value: '5'},
          {title: '6. แสดงพฤติกรรมบริการไม่เหมาะสม / มีข้อร้องเรียนด้านพฤติกรรมบริการ', value: '6'}
        ]
      },
    },
    violence:  {
      clinical: {
        ...
        options: [
          {title: '0. ไม่ระบุระดับความรุนแรง', value: '0'},
          {title: 'A. เหตุการณ์ที่มีโอกาสที่จะก่อให้เกิดความคาดเคลื่อน', value: 'A'},
          {title: 'B. เกิดความคาดเคลื่อนแต่ไม่ถึงผู้ป่วย', value: 'B'},
          {title: 'C. เกิดความคาดเคลื่อนขึ้นกับผู้ป่วยแต่ไม่ทำให้ผู้ป่วยได้รับอันตราย', value: 'C'},
          {title: 'D. เกิดความคาดเคลื่อนขึ้นกับผู้ป่วย ต้องเฝ้าระวังให้มั่นใจว่าไม่เกิดอันตรายกับผู้ป่วย', value: 'D'},
          {title: 'E. เกิดความคาดเคลื่อนขึ้นกลับผู้ป่วยส่งผลให้เกิดอันตรายชั่วคราวและต้องบำบัดรักษา', value: 'E'},
          {title: 'F. เกิดความคาดเคลื่อนขึ้นกับผู้ป่วยส่งผลให้เกิดอันตรายชั่วคราวต้องนอนรพ.หรือนอนรพ.นานขึ้น', value: 'F'},
          {title: 'G. เกิดความคาดเคลื่อนขึ้นกับผู้ป่วยส่งผลให้เกิดอันตรายแก่ผู้ป่วย', value: 'G'},
          {title: 'H. เกิดความคาดเคลื่อนขึ้นกับผู้ป่วยส่งผลให้ต้องทำการช่วยชีวิต', value: 'H'},
          {title: 'I. เกิดความคาดเคลื่อนขึ้นกับผู้ป่วยอาจเป็นสาเหตุของการเสียชีวิต (Sentinel event)', value: 'I'},
